...
public class Translation2d implements ITranslation2d<Translation2d> {
  ...
  public boolean epsilonEquals(final Translation2d other, double epsilon) {
    return MathUtils.epsilonEquals(x(), other.x(), epsilon)
        && MathUtils.epsilonEquals(y(), other.y(), epsilon);
  }
  ...
  public boolean equals(final Object other) {
    ...
    return distance((Translation2d) other) < MathUtils.DEFAULT_MAX_ERROR;
  }
